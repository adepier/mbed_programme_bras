...
hall_driven_motor motor1(PB_0,PA_12, pwm, 4, 5,val1,'A',FLAG_START_1,FLAG_STOP_1);
hall_driven_motor motor2(PB_1,PA_8, pwm,7, 6,val2,'B',FLAG_START_2,FLAG_STOP_2);
...
void init() {
    ...
    motor1.set_min_motor_speed(1000);
