...
int main()
{
  ...
  while (true)
  {
    ...
    event_flag.set(FLAG_START_DOIGT_1);     // démarre les moteurs
    event_flag.wait_all(FLAG_STOP_DOIGT_1); // attend que les moteurs
    ...
    // doigt_1.set_target_to_close_and_keep() ;// on ouvre le doigt
