...
int main()
{
  ...
  while (true)
  {
    ...
    event_flag.set(FLAG_START_DOIGT_2);     // démarre les moteurs
    event_flag.wait_all(FLAG_STOP_DOIGT_2); // attend que les moteurs
    ...
    // doigt_2.set_target_to_close_and_keep() ;// on ouvre le doigt
